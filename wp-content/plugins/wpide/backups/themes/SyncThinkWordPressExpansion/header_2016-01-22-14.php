        ...
        <header id="header">
            <div class="inner_container">
                <div class="hdr_sec navigation">
                     <div class="logo"><a href="<?php echo get_home_url();?>"><img src="<?php echo ot_get_option('first_logo'); ?> " alt="" /></a></div>
