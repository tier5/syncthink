<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ec37914c96f30ae7df28fb04705d823baa91a8bf9c"){
 ...
 <section class="article_wrap">
                <div class="inner_container">
					...
					$content = get_the_content(); 
                        ...
                        <a href="<?php the_permalink(); ?>" target="_blank" class="article">Full Article<i><img src="<?php echo get_stylesheet_directory_uri()?>/css/images/arrow.png" alt="" /></i></a>
							<?php 
								endwhile; 
							wp_reset_query(); 
									?>
         ...
         <section class="reserach_wrap">
                <div class="inner_container">
                    <div class="news_wrapper">
						...
						?>
                        <h3 class="news_hdng"><?php the_title();?></h3>
                        <span class="src_name"><?php the_field('add_name_of_source');?><strong>|</strong> <?php the_field('add_publication_date'); ?></span><span class="feature"><strong><img src="<?php echo get_stylesheet_directory_uri()?>/css/images/" alt="" /></strong>Featured</span>
                        <p class="para"><?php 
					        $content = get_the_content(); 
							echo substr(strip_tags($content), 0, 200) . '...'; 
						?></p>
                ...
                <div class="inner_container">
                    <div class="news_wrapper">
						...
						if($fimage) {	?>					
							...
							echo substr(strip_tags($content), 0, 200) . '...'; 
						?></p>
                                <a class="article" href="<?php the_permalink(); ?>" target="_blank">View<i><img alt="" src="<?php echo get_stylesheet_directory_uri()?>/css/images/arrow.png"></i></a>
                            </div>
							<?php 
							$i++;	endwhile; 
							wp_reset_query(); 
