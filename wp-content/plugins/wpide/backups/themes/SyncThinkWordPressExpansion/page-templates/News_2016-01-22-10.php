...
?>	Curents tags|<a href="<?php echo get_tag_link($tag_id); ?>"><?php echo implode(" ",$tags_arr); ?></a>
				...
				while (have_posts()) : the_post(); 
					?>
						...
						<p>Tags<strong>|</strong><?php  echo get_the_tag_list('',' ','');  ?></p>
