<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5632f0328d9e3f81c63e058515d9b56fdd266cbee3"){
                ...
                <div class="inner_container">
                    <div class="news_wrapper">
                        <h3> <span class="icon"><img src="<?php the_field('add_concussion_news_icon');?>" alt="" /></span><?php the_field('add_concussion_news_text');?></h3>
							...
							<?php 
								query_posts(array('post_type'=>'post','cat'=>4,'posts_per_page'=>'1','order'=>'DESC')); 
							while(have_posts()) : the_post();
						?>
                        <h3 class="news_hdng"><?php the_title();?></h3>
                        <span class="src_name"><?php the_field('add_name_of_source');?> <strong>|</strong> <?php the_time('M. j, Y'); ?></span><span class="feature"><strong><img src="<?php echo get_stylesheet_directory_uri()?>/css/images/icon1.png" alt="" /></strong>Featured</span>
                        <p class="para"><?php 
					$content = get_the_content(); 
                        ...
                        <div class="recent_atc_wrap">
                            <a href="<?php the_field('add_recent_headlines_link');?>">Recent Headlines</a>
							<?php 
                        ...
                        <span class="dotted_divider"></span>
                        <a href="<?php the_field('add_view_full_archive_link_of_concussion_news');?>" class="archive">View Full Archive<i><img src="<?php echo get_stylesheet_directory_uri()?>/css/images/arrow.png" alt="" /></i></a>
                    </div>
                </div>
        </section>
         ...
         <section class="reserach_wrap">
                <div class="inner_container">
                    <div class="news_wrapper">
						...
						<?php 
								query_posts(array('post_type'=>'post','cat'=>6,'posts_per_page'=>'1','order'=>'DESC')); 
							while(have_posts()) : the_post();
						?>
                        <h3 class="news_hdng"><?php the_title();?></h3>
                        <span class="src_name"><?php the_field('add_name_of_source');?><strong>|</strong> <?php the_time('M. j, Y'); ?></span>
                        ...
                        <div class="recent_atc_wrap">
                            <a href="<?php the_field('add_latest_research_link');?>">Latest Research</a>
							<?php 
                        ...
                        <span class="dotted_divider"></span>
                        <a href="<?php the_field('add_view_full_archive_link_of_research');?>" class="archive">View Full Archive<i><img src="<?php echo get_stylesheet_directory_uri()?>/css/images/arrow.png" alt="" /></i></a>
                    </div>
                </div>
        </section>
                ...
                <div class="inner_container">
                    <div class="news_wrapper">
						...
						if($fimage) {	?>					
							...
							echo substr(strip_tags($content), 0, 200) . '...'; 
						?></p>
                                <a class="article" href="<?php the_permalink(); ?> ">View<i><img alt="" src="<?php echo get_stylesheet_directory_uri()?>/css/images/arrow.png"></i></a>
                            </div>
							<?php 
							$i++;	endwhile; 
							wp_reset_query(); 
                        ...
                        <span class="dotted_divider"></span>
                        <a href="<?php the_field('add_view_full_archive_link_of_parents');?>" class="archive">View Full Archive<i><img src="<?php echo get_stylesheet_directory_uri()?>/css/images/arrow.png" alt="" /></i></a>
                    </div>
                </div>
        </section>
