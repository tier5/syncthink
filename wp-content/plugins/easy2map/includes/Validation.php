...
<form id="save-easy2map_key" name="save-easy2map_key" action="" method="post">
    ...
    <table style="background-color:#EBEBEB;width:80%;margin-top:10px;margin-left:auto;margin-right:auto;" cellspacing="3" cellpadding="3" class="table table-bordered">
        ...
        <table style="background-color:#EBEBEB;margin-top:40px;margin-left:auto;margin-right:auto;width:80%;" cellspacing="3" cellpadding="3" class="table table-bordered">
            ...
            <tr><td colspan="2" style="text-align:center"><img class="exampleImg" src="<?php echo easy2map_get_plugin_url('/images/map_example_3.png'); ?>" /></td></tr>
            <tr><td colspan="2" style="text-align:center"><img class="exampleImg" src="<?php echo easy2map_get_plugin_url('/images/map_example_2.png'); ?>" /></td></tr>
            <tr><td colspan="2" style="text-align:center"><img class="exampleImg" src="<?php echo easy2map_get_plugin_url('/images/map_example_1.png'); ?>" /></td></tr>
        </table>
